...
// import 자동 입력 : Ctrl + Shift + o (alphabet)
...
//        int random;
//        boolean isDuplicate;						// boolean 변수명앞에 is붙이는게 관행. 
//        boolean isConsecutiveThree;
//        do {
...
//
//            for (int j = 0; j < i; j++) {
//                if (lottoNumbers[j] == random) {
//                    isDuplicate = true;
//                    break;
//                }
//
//                if (i >= 2 && lottoNumbers[j] == random && lottoNumbers[j - 1] == random && lottoNumbers[j - 2] == random) {
//                    isConsecutiveThree = true;
//                    break;
//                }
//            }
//        } while (isDuplicate || isConsecutiveThree);
//
